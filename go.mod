...
require (
	...
	go.lumeweb.com/web/go/portal-dashboard v0.0.0-20241101102719-a885b1cc71e0
...
require (
	...
	github.com/golang-queue/queue v0.1.4-0.20240914022627-ee5b6a2bee11 // indirect
	...
	github.com/wneessen/go-mail v0.5.1 // indirect
